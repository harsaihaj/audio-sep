# -*- coding: utf-8 -*-
"""Copy of Music_ELC.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1PK7ds47XyJ4a6QWqXCQADpUDqG1mjCyx
"""
...
axs[0, 1].plot(x2, label='Original Source 1')
axs[0, 1].plot(y[0], 'r', label='Separated Source 1')
axs[0, 1].set_title('Separated Signal 1')
axs[0, 1].legend()

axs[1, 0].plot(x3, label='Original Source 2')
axs[1, 0].plot(y[1], 'r', label='Separated Source 2')
axs[1, 0].set_title('Separated Signal 2')
axs[1, 0].legend()

axs[1, 1].plot(x4, label='Original Source 3')
axs[1, 1].plot(y[2], 'r', label='Separated Source 3')
...
# Play individual components
for i, comp in enumerate(y):
    print(f"Playing separated component {i+1}")
    ipd.Audio(comp, rate=fs)
    display(ipd.Audio(comp, rate=fs))
